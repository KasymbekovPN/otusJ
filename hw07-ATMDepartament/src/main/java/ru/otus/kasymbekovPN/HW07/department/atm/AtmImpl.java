...
import ru.otus.kasymbekovPN.HW07.department.atm.visitor.Visitor;
import ru.otus.kasymbekovPN.HW07.department.banknotes.*;
import ru.otus.kasymbekovPN.HW07.department.banknotes.Currency;
...
public class AtmImpl implements Atm, Displayable, VisitedElement, Originator {
    ...
    /**
     * Создает хранитель состояния  банкомата
     * @return Храниель состояни ябанкомата
     */
    @Override
