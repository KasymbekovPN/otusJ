...
public class GetDelUserResponseHandler implements RequestHandler {

    private static final Logger logger = LoggerFactory.getLogger(GetDelUserResponseHandler.class);

    private final FrontendService frontendService;

    public GetDelUserResponseHandler(FrontendService frontendService) {
