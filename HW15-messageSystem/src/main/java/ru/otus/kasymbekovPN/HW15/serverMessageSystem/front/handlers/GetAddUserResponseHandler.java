...
public class GetAddUserResponseHandler implements RequestHandler {

    private static final Logger logger = LoggerFactory.getLogger(GetAddUserResponseHandler.class);

    private final FrontendService frontendService;

    public GetAddUserResponseHandler(FrontendService frontendService) {
