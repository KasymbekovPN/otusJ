...
import ru.otus.kasymbekovPN.HW16.sockets.inputHandler.frontend.AddUserRespSIHandler;
import ru.otus.kasymbekovPN.HW16.sockets.inputHandler.frontend.AuthUserRespSIHandler;
import ru.otus.kasymbekovPN.HW16.sockets.inputHandler.frontend.DelUserRespSIHandler;
import ru.otus.kasymbekovPN.HW16.sockets.inputHandler.frontend.WrongRespSIHandler;

@Configuration
@RequiredArgsConstructor
public class SocketHandConfig {
    ...
    public SocketHandler socketHandler(){
        ...
        //< !!! replace port value
        SocketHandler socketHandler = SocketHandlerImpl.newInstance("localhost", 8083);
        //< ???
