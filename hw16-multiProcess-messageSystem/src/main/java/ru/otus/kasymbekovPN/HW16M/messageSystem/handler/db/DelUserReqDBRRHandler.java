...
public class DelUserReqDBRRHandler implements ReqRespHandler {

    private  static final Logger logger = LoggerFactory.getLogger(DelUserReqDBRRHandler.class);

    private final SocketHandler socketHandler;

    public DelUserReqDBRRHandler(SocketHandler socketHandler) {
        this.socketHandler = socketHandler;
    }

    @Override
    public Optional<Message> handle(Message message) {
        logger.info("DelUserReqDBRRHandler : {}", message);
