...
public class SocketHandlerConfig {
    ...
    public SocketHandler socketHandler(){
        ...
        socketHandler.addHandler(ReqRespType.ADD_USER_RESPONSE.getValue(), new AddUserResponseSIH(msClientService));
        socketHandler.addHandler(ReqRespType.DEL_USER_REQUEST.getValue(), new DelUserRequestSIH(msClientService, socketHandler));
        socketHandler.addHandler(ReqRespType.DEL_USER_RESPONSE.getValue(), new DelUserResponseSIH(msClientService));
        //<
