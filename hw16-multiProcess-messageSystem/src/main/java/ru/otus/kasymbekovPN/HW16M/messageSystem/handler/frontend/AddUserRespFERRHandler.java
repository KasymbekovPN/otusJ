...
public class AddUserRespFERRHandler implements ReqRespHandler {

    private static final Logger logger = LoggerFactory.getLogger(AddUserRespFERRHandler.class);

    private final SocketHandler socketHandler;

    public AddUserRespFERRHandler(SocketHandler socketHandler) {
        this.socketHandler = socketHandler;
    }

    @Override
    public Optional<Message> handle(Message message) {
        logger.info("AddUserRespFERRHandler : {}", message);
