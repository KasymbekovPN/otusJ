...
public class DbMsClientCreator implements MsClientCreator {
    ...
    public MsClient create(String url, SocketHandler socketHandler, MessageSystem messageSystem) {
        ...
        msClient.addHandler(ReqRespType.AUTH_USER_REQUEST, new CommonMSMessageHandler(socketHandler));
        msClient.addHandler(ReqRespType.ADD_USER_REQUEST, new CommonMSMessageHandler(socketHandler));
        msClient.addHandler(ReqRespType.DEL_USER_REQUEST, new CommonMSMessageHandler(socketHandler));
