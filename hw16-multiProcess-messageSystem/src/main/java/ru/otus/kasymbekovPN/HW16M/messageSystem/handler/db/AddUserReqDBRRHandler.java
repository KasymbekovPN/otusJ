...
public class AddUserReqDBRRHandler implements ReqRespHandler {

    private static final Logger logger = LoggerFactory.getLogger(AddUserReqDBRRHandler.class);

    private final SocketHandler socketHandler;

    public AddUserReqDBRRHandler(SocketHandler socketHandler) {
        this.socketHandler = socketHandler;
    }

    @Override
    public Optional<Message> handle(Message message) {
        logger.info("AddUserReqDBRRHandler : {}", message);
