...
class DataSourceH2Test {
    ...
    void testGetConnectionWithoutArgs(String url) throws SQLException {
        ...
        Connection conn1 = new DataSourceH2().getConnection();
    ...
    void testGetConnectionWithArgs() {
        assertThatThrownBy(()->{
            new DataSourceH2().getConnection("", "");
    ...
    void testGetLoginTimeout(){
        assertThatThrownBy(()->{
            new DataSourceH2().getLoginTimeout();
        }).isInstanceOf(UnsupportedOperationException.class);
    }
    ...
    void testSetLoginTimeout(){
        assertThatThrownBy(()->{
            new DataSourceH2().setLoginTimeout(0);
        }).isInstanceOf(UnsupportedOperationException.class);
    }
    ...
    void testUnwrap(){
        assertThatThrownBy(()->{
            new DataSourceH2().unwrap(Object.class);
        }).isInstanceOf(UnsupportedOperationException.class);
    }
    ...
    void testIsWrapperFor(){
        assertThatThrownBy(()->{
            new DataSourceH2().isWrapperFor(Object.class);
        }).isInstanceOf(UnsupportedOperationException.class);
    }
    ...
    void testGetParentLogger(){
        assertThatThrownBy(()->{
            new DataSourceH2().getParentLogger();
        }).isInstanceOf(UnsupportedOperationException.class);
    }
