...
public class ResultSetHelperImpl implements ResultSetHelper {
     ...
     */
    @Override
    public void setKeyField(ResultSet rs, Object instance, Field key) throws SQLException, IllegalAccessException {
        rs.next();
     ...
     */
    @Override
    public Object makeInstance(ResultSet rs, Class clazz, Field key, List<Field> others) throws SQLException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
