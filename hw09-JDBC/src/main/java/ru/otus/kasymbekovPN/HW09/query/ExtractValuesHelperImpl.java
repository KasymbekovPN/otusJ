...
public class ExtractValuesHelperImpl implements ExtractValuesHelper {
     ...
     */
    @Override
    public Object extractKeyValue(Object instance, Field key) throws IllegalAccessException {
     ...
     */
    @Override
    public List<Object> extractOtherValues(Object instance, List<Field> others) throws IllegalAccessException {
