...
Для минорных сборок Serial GC и G1 GC показали примерно одинаковые<br>
результаты. Serial GC занимает от 0.91% до 1.77% времени, в течении<br>
которого происходят минорные сборки; в то время как G1 GC занимает<br>
от 0.46% до 1.84% времени в течении которого происходят минорные сборки.<br>
<br>
